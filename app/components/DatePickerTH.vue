                                ...
                                <div :class="cx('header')" v-bind="ptm('header')">
                                    ...
                                    <div :class="cx('title')" v-bind="ptm('title')">
                                        ...
                                        <span v-if="currentView === 'year'" :class="cx('decade')" v-bind="ptm('decade')">
                                            <slot name="decade" :years="yearPickerValues"> {{ yearPickerValues[0].value + 543 }} - {{ yearPickerValues[yearPickerValues.length - 1].value + 543}} </slot>
                                        </span>
                                    </div>
...
import BaseDatePicker from 'primevue/datepicker';
...
export default {
    ...
    methods: {
        ...
        formatDateTime(date) {
            ...
            if (date) {
                if (this.timeOnly) {
                    ...
                    formattedValue = Intl.DateTimeFormat('th',{year: "numeric",month: "2-digit",day: "2-digit"}).format(new Date(date))
        ...
        parseDateTime(text) {
            ...
            const normalizeDateText = (dateText) => {
            ...
            if (this.timeOnly) {
                ...
                if (this.showTime) {
                    const normalized = normalizeDateText(parts[0]);
                    date = this.parseDate(normalized, dateFormat);
